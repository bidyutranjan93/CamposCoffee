...
public class MyAccountTest extends WebElementUtil {
    ...
    public void verifyBrowseOrdersLinkOnTooltip(){
        ...
        softAssert.assertEquals(myAccountPage.getTextBrowseProductLink(), "BROWSE PRODUCTS", "User able to landed on the shop page");
        softAssert.assertAll();
    }
